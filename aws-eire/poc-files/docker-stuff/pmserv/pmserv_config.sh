...
yum install -y ERICenmsgpmservice_CXP9031580
/bin/cp -f /var/tmp/modclusterworkaround.sh /ericsson/performance_management/scripts/register_context_monitor.sh
yum install -y cronie.x86_64
