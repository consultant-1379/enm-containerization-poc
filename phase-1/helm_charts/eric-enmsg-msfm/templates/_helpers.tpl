...
*/}}
{{- define "eric-enmsg-msfm.fullname" -}}
...
*/}}
{{- define "eric-enmsg-msfm.registryUrl" -}}
...
*/}}
{{- define "eric-enmsg-msfm.pullSecrets" -}}
...
*/}}
{{- define "eric-enmsg-msfm.enmHost" -}}
...
Create replicas
*/}}
{{- define "eric-enmsg-msfm.replicas" -}}
{{- if index .Values "global" "replicas-eric-enmsg-msfm" -}}
{{- print (index .Values "global" "replicas-eric-enmsg-msfm") -}}
{{- else if index .Values "replicas-eric-enmsg-msfm" -}}
{{- print (index .Values "replicas-eric-enmsg-msfm") -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-enmsg-msfm.storageClass" -}}
...
*/}}
{{- define "eric-enmsg-msfm.secretName" -}}
{{ default (include "eric-enmsg-msfm.fullname" .) .Values.existingSecret }}
{{- end -}}
