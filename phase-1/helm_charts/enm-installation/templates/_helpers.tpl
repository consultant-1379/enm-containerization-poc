...
*/}}
{{- define "enm-installation.fullname" -}}
...
*/}}
{{- define "enm-installation.registryUrl" -}}
...
*/}}
{{- define "enm-installation.pullSecrets" -}}
...
*/}}
{{- define "enm-installation.enmHost" -}}
...
Create replicas
*/}}
{{- define "enm-installation.replicas" -}}
...
*/}}
{{- define "enm-installation.storageClass" -}}
...
*/}}
{{- define "enm-installation.secretName" -}}
{{ default (include "enm-installation.fullname" .) .Values.existingSecret }}
{{- end -}}
