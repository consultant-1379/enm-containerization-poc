...
*/}}
{{- define "eric-enm-nfspvc.fullname" -}}
...
*/}}
{{- define "eric-enm-nfspvc.registryUrl" -}}
...
*/}}
{{- define "eric-enm-nfspvc.pullSecrets" -}}
...
*/}}
{{- define "eric-enm-nfspvc.enmHost" -}}
...
Create replicas
*/}}
{{- define "eric-enm-nfspvc.replicas" -}}
{{- if index .Values "global" "replicas-eric-enm-nfspvc" -}}
{{- print (index .Values "global" "replicas-eric-enm-nfspvc") -}}
{{- else if index .Values "replicas-eric-enm-nfspvc" -}}
{{- print (index .Values "replicas-eric-enm-nfspvc") -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-enm-nfspvc.storageClass" -}}
...
*/}}
{{- define "eric-enm-nfspvc.secretName" -}}
{{ default (include "eric-enm-nfspvc.fullname" .) .Values.existingSecret }}
{{- end -}}
