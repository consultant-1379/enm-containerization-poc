...
*/}}
{{- define "eric-enmsg-mscm.fullname" -}}
...
*/}}
{{- define "eric-enmsg-mscm.registryUrl" -}}
...
*/}}
{{- define "eric-enmsg-mscm.pullSecrets" -}}
...
*/}}
{{- define "eric-enmsg-mscm.enmHost" -}}
...
Create replicas
*/}}
{{- define "eric-enmsg-mscm.replicas" -}}
{{- if index .Values "global" "replicas-eric-enmsg-mscm" -}}
{{- print (index .Values "global" "replicas-eric-enmsg-mscm") -}}
{{- else if index .Values "replicas-eric-enmsg-mscm" -}}
{{- print (index .Values "replicas-eric-enmsg-mscm") -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-enmsg-mscm.storageClass" -}}
...
*/}}
{{- define "eric-enmsg-mscm.secretName" -}}
{{ default (include "eric-enmsg-mscm.fullname" .) .Values.existingSecret }}
{{- end -}}
