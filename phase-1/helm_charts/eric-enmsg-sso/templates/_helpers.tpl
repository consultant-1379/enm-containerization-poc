...
*/}}
{{- define "eric-enmsg-sso.fullname" -}}
...
*/}}
{{- define "eric-enmsg-sso.registryUrl" -}}
...
*/}}
{{- define "eric-enmsg-sso.pullSecrets" -}}
...
Create replicas
*/}}
{{- define "eric-enmsg-sso.replicas" -}}
{{- if index .Values "global" "replicas-eric-enmsg-sso" -}}
{{- print (index .Values "global" "replicas-eric-enmsg-sso") -}}
{{- else if index .Values "replicas-eric-enmsg-sso" -}}
{{- print (index .Values "replicas-eric-enmsg-sso") -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-enmsg-sso.storageClass" -}}
...
*/}}
{{- define "eric-enmsg-sso.secretName" -}}
{{ default (include "eric-enmsg-sso.fullname" .) .Values.existingSecret }}
{{- end -}}
