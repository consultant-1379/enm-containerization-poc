...
*/}}
{{- define "adp-integration.fullname" -}}
...
*/}}
{{- define "adp-integration.registryUrl" -}}
...
*/}}
{{- define "adp-integration.pullSecrets" -}}
...
*/}}
{{- define "adp-integration.enmHost" -}}
...
Create replicas
*/}}
{{- define "adp-integration.replicas" -}}
...
*/}}
{{- define "adp-integration.storageClass" -}}
...
*/}}
{{- define "adp-integration.secretName" -}}
{{ default (include "adp-integration.fullname" .) .Values.existingSecret }}
{{- end -}}
